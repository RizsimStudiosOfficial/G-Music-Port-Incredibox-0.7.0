...
function preparerArray() {
  ...
  tabToLoad = [{
    ...
    "params": {
      "keyname": "spritePolo",
      "path": "./" + app.folder + "img/" + (0x1 == animSize ? appBrowserSchool ? "polo-sprite-tshirt.png" : "polo-sprite.png" : nameToHD(appBrowserSchool ? "polo-sprite-tshirt.png" : "polo-sprite.png"))
    }
  }, {
    "func": loadImage,
    "params": {
